...
export default function Home() {
  return (
    <div className="flex flex-col sm:gap-20 gap-12 flex-wrap">
      <div className="text-center text-[#E4E4E4]">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-4">
          <li className="flex flex-col items-center">
            ...
            >
              ...
              <p className="text-[#E4E4E4] text-2xl font-semibold">Ventas</p>
            </Link>
          </li>
          <li className="flex flex-col items-center">
            <Link
            ...
            >
              ...
              <p className="text-[#E4E4E4] text-2xl font-semibold">Kardex</p>
            </Link>
          </li>{" "}
          <li className="flex flex-col items-center">
            <Link
            ...
            >
              ...
              <p className="text-[#E4E4E4] text-2xl font-semibold">Registros</p>
            </Link>
          </li>
        </ul>
      </div>
